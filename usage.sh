...
"$venv" update cached_wallpapers "Adelph" --env "$temp_install_dir" --variable-type array
...
"$venv" update cached_wallpapers "some" --env "$temp_install_dir" --variable-type array
eval "cached_wallpapers=( $("$venv" get cached_wallpapers --env "$temp_install_dir") )"
echo "Updated cached wallpapers are: ${cached_wallpapers[@]}"
